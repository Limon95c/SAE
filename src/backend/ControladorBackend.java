...
public class ControladorBackend{
    ...
    public Alumno createAlumno(String Nombre, String Correo){
        ...
        ArrayList<Falta> temp = new ArrayList<Falta>();
        Alumno nuevo = new Alumno(ID, Nombre, Correo, 0, 0, 0, temp, this);
    ...
    public Profesor createProfesor(String Nombre, String puesto, 
        ...
        Profesor nuevo = new Profesor(1, Nombre, puesto, Correo, this);
    ...
    public Falta createFalta(Fecha fecha, int tipo){
        /*
        ...
        Falta nuevo = new Falta(ID, fecha, tipo, this);
    ...
    public boolean cargarAlumnos(){
        ...
        try{
            while(rafAlumnos.getFilePointer() < rafAlumnos.length()){
                ...
                Alumno nuevo = new Alumno(ID, Nombre, Correo, 0, 0, 0, faltas, this);
                this.Alumnos.add(nuevo);
            }
        }catch(IOException e){
    ...
    private boolean cargarFaltas(){
        ...
        try{    
            while(this.rafFaltas.getFilePointer() < this.rafFaltas.length()){
                ...
                Fecha fecha = new Fecha(dia, month, year);
                int tipo = this.rafFaltas.readInt();
                Falta falta = new Falta(ID, fecha, tipo, this);
    ...
    public Periodo encontrarPeriodo(int Mi, int Mf, int anio) {
        for(Periodo A : Periodos){
            if(A.getMesInicio() == Mi && A.getMesFin() == Mf && A.getYear() == anio)
                return A;
        }
        return null;
    }
